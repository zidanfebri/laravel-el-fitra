...
@section('content')
    <div class="container-fluid p-0">
        <div id="sdSlider" class="carousel slide carousel-fade slider-container" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('images/sd1.jpeg') }}" class="d-block w-100" alt="SD Slider 1" loading="lazy">
                    <div class="carousel-caption">
                        <h1>SD EL-FITRA</h1>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/sd2.jpeg') }}" class="d-block w-100" alt="SD Slider 2" loading="lazy">
                    <div class="carousel-caption">
                        <h1>SD EL-FITRA</h1>
                    </div>
                </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#sdSlider" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#sdSlider" data-bs-slide="next">
            ...
            <div class="row vision-mission">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <p>Menjadikan SD El-Fitra sebagai pusat pendidikan dasar berbasis Islami yang unggul dan berakhlak mulia.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <ul>
                            <li>Menyediakan pembelajaran berkualitas.</li>
                            <li>Membangun karakter Islami siswa.</li>
                            <li>Mendukung prestasi akademik dan ekstrakurikuler.</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="program-container">
                        <div class="program-wrapper">
                            @php
                                $programs = [
                                    ['icon' => 'bi-book', 'title' => 'Pendidikan Umum', 'desc' => 'Kurikulum nasional.'],
                                    ['icon' => 'bi-trophy', 'title' => 'Ekstrakurikuler', 'desc' => 'Olahraga dan seni.'],
                                    ['icon' => 'bi-alarm', 'title' => 'Bimbingan Belajar', 'desc' => 'Dukungan tambahan.'],
                                    ['icon' => 'bi-heart', 'title' => 'Pendidikan Karakter', 'desc' => 'Pembentukan akhlak.'],
                                    ['icon' => 'bi-globe', 'title' => 'Bahasa Asing', 'desc' => 'Bahasa Inggris dasar.'],
                                    ['icon' => 'bi-calculator', 'title' => 'Matematika Kreatif', 'desc' => 'Pembelajaran interaktif.'],
