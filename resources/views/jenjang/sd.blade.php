...
@section('content')
    <section id="home" class="hero-area">
        <div class="video-container">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-center">
                <h1 class="slider-text-fixed">SD {{ __('messages.site_name') }}</h1>
            </div>
            ...
            <div class="tentang-kami-container">
                ...
                <div class="tentang-kami-content">
                    <div class="section-header">
                        ...
                        <p class="lead">{{ app()->getLocale() === 'en' ? __('messages.about_us_text_en') : __('messages.about_us_text') }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="lokasi-content card h-100 p-4">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0">{{ __('messages.address_sd') }}</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0">{{ __('messages.telfon_sd') }}</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0">{{ __('messages.email_sd') }}</p>
                            </div>
                        </div>
                        <a href="https://www.google.com/maps/place/SD+El+Fitra/@-6.9248255,107.6603676,759m/data=!3m2!1e3!4b1!4m6!3m5!1s0x2e68e7fe4715d329:0x9997de36a3a498ce!8m2!3d-6.9248308!4d107.664981!16s%2Fg%2F11b6969w84?entry=ttu&g_ep=EgoyMDI1MDkxNy4wIKXMDSoASAFQAw%3D%3D" target="_blank" class="main-button mt-3">{{ __('messages.open_in_google_maps') }}</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="lokasi-map card h-100">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.902260677367!2d107.664981!3d-6.9248308!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e7fe4715d329:0x9997de36a3a498ce!2sSD%20El%20Fitra!5e0!3m2!1sen!2sid!4v1634567890123!5m2!1sen!2sid" 
                                width="100%" 
                                height="400" 
    ...
    <section id="vision-mission" class="jenjang-section animate__animated animate__fadeInUp">
        <div class="container">
            <div class="section-header">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="jenjang-card text-center">
                        ...
                        <a class="course-title">{{ __('messages.mission') }}</a>
                        <div class="teks-visimisi">
                            <ul>
    ...
    <section id="pendaftaran" class="pendaftaran-section animate__animated animate__fadeIn" style="margin-top: 50px;">
