        ...
        <div id="imageSlider" class="carousel slide carousel-fade slider-container" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('images/smp1.jpg') }}" class="d-block" alt="{{ __('messages.slider_1') }}" loading="lazy">
                    <div class="carousel-caption">
                        <h1 class="slider-text-fixed">SMP EL-FITRA</h1>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/smp2.jpg') }}" class="d-block" alt="{{ __('messages.slider_2') }}" loading="lazy">
                    <div class="carousel-caption">
                        <h1 class="slider-text-fixed">SMP EL-FITRA</h1>
                    </div>
                </div>
