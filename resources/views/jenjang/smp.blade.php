...
@section('content')
    <div class="container-fluid p-0">
        <div id="smpSlider" class="carousel slide carousel-fade slider-container" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('images/smp1.jpeg') }}" class="d-block w-100" alt="SMP Slider 1" loading="lazy">
                    <div class="carousel-caption">
                        <h1>SMP EL-FITRA</h1>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/smp2.jpeg') }}" class="d-block w-100" alt="SMP Slider 2" loading="lazy">
                    <div class="carousel-caption">
                        <h1>SMP EL-FITRA</h1>
                    </div>
                </div>
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#smpSlider" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#smpSlider" data-bs-slide="next">
            ...
            <div class="row vision-mission">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <p>Menjadikan SMP El-Fitra sebagai sekolah menengah unggul berbasis Islami.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <ul>
                            ...
                            <li>Membangun karakter Islami.</li>
                            <li>Menyediakan fasilitas modern.</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="program-wrapper">
                            @php
                                $programs = [
                                    ...
                                    ['icon' => 'bi-trophy', 'title' => 'Kompetisi', 'desc' => 'Lomba akademik.'],
                                    ['icon' => 'bi-alarm', 'title' => 'Bimbingan Konseling', 'desc' => 'Dukungan emosional.'],
                                    ...
                                    ['icon' => 'bi-gear', 'title' => 'Keterampilan Teknologi', 'desc' => 'Pengenalan IT.'],
