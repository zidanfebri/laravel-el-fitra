    ...
    <nav class="navbar navbar-expand-lg py-1 sticky-top">
        <div class="container-fluid px-lg-5 px-3"> 
            <a class="navbar-brand d-flex align-items-center sitename-orange" href="{{ route('home') }}">
                <img src="{{ asset('images/elfitra.jpeg') }}" width="40" class="me-2 rounded-circle"> {{ __('messages.site_name_menu') }}
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-3">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">{{ __('messages.profil_smp') }} <i class="bi bi-chevron-down ms-1"></i></a>
                        <ul class="dropdown-menu border-0 shadow">
                            <li><a class="dropdown-item" href="{{ route('jenjang.smp') }}#tentang-kami">{{ __('messages.about_us') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('jenjang.smp') }}#vision-mission">{{ __('messages.vision_mission') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('jenjang.smp') }}#fasilitas">{{ __('messages.facilities') }}</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle p-0 d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                            <span class="fi fi-{{ app()->getLocale() == 'id' ? 'id' : 'gb' }}"></span><i class="bi bi-chevron-down ms-1 icon-small"></i>
                        </a>
        ...
        <div class="container-fluid px-lg-5 px-3"> 
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <div class="footer-social"><a href="#"><i class="bi bi-facebook"></i></a><a href="#"><i class="bi bi-twitter"></i></a><a href="https://www.instagram.com/smaelfitra_official/"><i class="bi bi-instagram"></i></a><a href="#"><i class="bi bi-tiktok"></i></a></div>
                </div>
                <div class="col-lg-2 col-md-6 mb-4">
                    <h5>{{ __('messages.footer_links') }}</h5>
                    <ul class="list-unstyled"><li><a href="{{ route('home') }}">{{ __('messages.home') }}</a></li><li><a href="{{ route('pendaftaran.check') }}">{{ __('messages.registration') }}</a></li></ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="footer-bottom text-center">
                ...
                <p class="mb-0 mt-2">{{ __('messages.total_visits') }}: <span class="visit-count">{{ \App\Models\Visit::first()->smp_count ?? 0 }}</span></p>
            </div>
        </div>
    </footer>
    ...
    <div class="modal fade" id="waModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-success text-white"><h6 class="modal-title">Contact Unit</h6><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
