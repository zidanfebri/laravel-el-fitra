            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-3">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">{{ __('messages.profil_tk') }} <i class="bi bi-chevron-down ms-1"></i></a>
                        <ul class="dropdown-menu border-0 shadow">
                            <li><a class="dropdown-item" href="{{ route('jenjang.tk') }}#tentang-kami">{{ __('messages.about_us') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('jenjang.tk') }}#vision-mission">{{ __('messages.vision_mission') }}</a></li>
                            <li><a class="dropdown-item" href="{{ route('jenjang.tk') }}#fasilitas">{{ __('messages.facilities') }}</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <footer class="footer py-4">
        <div class="container-fluid px-lg-5 px-3"> 
            ...
            <div class="footer-bottom text-center">
                ...
                <p class="mb-0 mt-2">{{ __('messages.total_visits') }}: <span class="visit-count">{{ \App\Models\Visit::first()->tk_count ?? 0 }}</span></p>
            </div>
        </div>
    </footer>
