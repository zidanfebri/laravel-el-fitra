...
<head>
    ...
    <title>Tambah Berita - El-Fitra</title>
...
<body>
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="mb-4" id="contentTitle">Tambah Berita</h2>
        @if ($errors->any())
        ...
        <div class="form-container">
            <form action="{{ route('admin.store-berita') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 date-wrapper">
                    ...
                    <input type="date" class="form-control date-input" id="tanggal_terbit" name="tanggal_terbit" value="{{ old('tanggal_terbit') }}" required>
                </div>
                <div class="mb-3">
