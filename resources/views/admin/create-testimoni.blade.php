...
<head>
    ...
    <title>Tambah Testimoni - El-Fitra</title>
...
<body>
    ...
    <!-- Content -->
    <div class="content">
        <h2 class="mb-4" id="contentTitle">Tambah Testimoni</h2>
        @if ($errors->any())
        ...
        <div class="form-container">
            <form action="{{ route('admin.store-testimoni') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3 date-wrapper">
                    ...
                    <input type="date" class="form-control date-input" id="tanggal" name="tanggal" value="{{ old('tanggal') }}" required>
                </div>
                <div class="mb-3">
